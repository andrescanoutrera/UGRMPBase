...
1. Prepara tu ordenador para trabajar con la asignatura
   - Si quieres seguir en Windows, instala [VirtualBox](README.md#virtualbox) y la imagen de arranque especial que hemos preparado para la asignatura. Es una distribución KUbuntu como la que está en las aulas de prácticas y ya viene con todo instalado.
